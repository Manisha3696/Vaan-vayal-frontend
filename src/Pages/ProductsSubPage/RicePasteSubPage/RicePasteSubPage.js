                ...
                <main className="main mb-5 mx-auto">
                    <div className="product-details-container">
                        <div className="product-image">
                            <img src={ricePaste.image} alt={ricePaste.name} style={{ width: "80%" }} />
                        </div>
                        <div className="product-details">
                            <h3 style={{ color: "#2e7d32" }}>{ricePaste.title}</h3>
                            <p className="price">{ricePaste.priceRange}</p>
                            <p className="description">{ricePaste.description}</p>
                            <div className="categories">Categories: Best Deals, Organic Rice Paste Exporters</div>
                        </div>
                    </div>
                </main>
            </div>
